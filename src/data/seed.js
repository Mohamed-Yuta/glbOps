...
export const seedEmployees = () => [
  ...
  {
    id: "EMP-013", nom: "R. Zouiten",
    ...blankEmployee({
      role: "Agent Chantier", poste: "Ancien technicien", telephone: "06 73 32 42 52", email: "r.zouiten@globetudes.ma", dateEmbauche: "04/03/2015",
...
export const seedClients = () => [
  ...
  { id: "CLI-0305", nom: "Particulier — M. Bennani", code: "CLI-0305" },
];
    ...
    prestations: [
      blankPrestation({
        ...
        history: [
          ...
          { date: "29/08/2026", label: "Affectation : A. Oubrik — visite prévue le 05/09/2026" },
    ...
    prestations: [
      blankPrestation({
        ...
        history: [
          ...
          { date: "17/08/2026", label: "Affectation : S. Rami — visite prévue le 20/08/2026" },
    ...
    prestations: [
      blankPrestation({
        ...
        history: [
          ...
          { date: "07/09/2026", label: "Affectation : Y. Chraibi — visite prévue le 08/09/2026" },
        ],
      }),
    ],
  },
    ...
    prestations: [
      blankPrestation({
        ...
        history: [
          ...
          { date: "03/06/2026", label: "Affectation : K. Momayiz — visite prévue le 05/06/2026" },
